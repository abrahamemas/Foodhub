...
import 'package:foodhub/service/food_api/category/mexican_category/api.dart';
import 'package:foodhub/service/food_api/model.dart';
import 'package:shimmer/shimmer.dart';

class MexicanCategoryScreen extends ConsumerWidget {
  const MexicanCategoryScreen({Key? key, required this.recipeCount})
      : super(key: key);
  final String query = "Taco";
  final int recipeCount;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(searchMexicanDataProvider(query));
