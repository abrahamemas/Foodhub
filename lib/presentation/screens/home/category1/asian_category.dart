...
import 'package:foodhub/service/food_api/category/asian_category/api.dart';
import 'package:foodhub/service/food_api/model.dart';
import 'package:shimmer/shimmer.dart';

class AsianCategoryScreen extends ConsumerWidget {
  const AsianCategoryScreen({Key? key, required this.recipeCount})
      : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(searchAsianDataProvider);
