...
import 'package:foodhub/service/food_api/category/pizza_categroy/api.dart';
import 'package:foodhub/service/food_api/model.dart';
import 'package:shimmer/shimmer.dart';

class PizzaCategoryScreen extends ConsumerWidget {
  final String query = "Pizza";
  final int recipeCount;

  const PizzaCategoryScreen({Key? key, required this.recipeCount})
      : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(searchPizzaDataProvider(query));
