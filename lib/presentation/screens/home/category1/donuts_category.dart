...
import 'package:foodhub/service/food_api/category/donuts_category/api.dart';
import 'package:foodhub/service/food_api/model.dart';
import 'package:shimmer/shimmer.dart';

class DonutsCategoryScreen extends ConsumerWidget {
  const DonutsCategoryScreen({Key? key, required this.recipeCount})
      : super(key: key);
  final String query = "Donut";
  final int recipeCount;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(searchDonutsDataProvider(query));
