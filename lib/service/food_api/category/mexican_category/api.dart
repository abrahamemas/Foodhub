...
final searchMexicanProvider =
    Provider<SearchMexicanService>((ref) => SearchMexicanService());
final searchMexicanDataProvider =
    FutureProvider.family<List<Recipe>, String>((ref, query) async {
  final apiService = ref.read(searchMexicanProvider);
  return apiService.fetchRecipes(query);
});

class SearchMexicanService {
