...
final searchBurgerProvider =
    Provider<SearchBurgerService>((ref) => SearchBurgerService());
final searchBurgerDataProvider =
    FutureProvider.family<List<Recipe>, String>((ref, query) async {
  final apiService = ref.read(searchBurgerProvider);
  return apiService.fetchRecipes(query);
});

class SearchBurgerService {
